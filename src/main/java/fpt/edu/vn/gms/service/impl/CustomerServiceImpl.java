...
public class CustomerServiceImpl implements CustomerService {
    ...
    public CustomerResponseDto updateCustomer(Long id, CustomerRequestDto dto) {
        ...
        // Cập nhật discountPolicy dựa trên CustomerLoyaltyLevel trong DTO
        if (dto.getCustomerLoyaltyLevel() != null) {
            DiscountPolicy discountPolicy = discountPolicyRepository
                    .findByLoyaltyLevel(dto.getCustomerLoyaltyLevel())
                    .orElseThrow(() -> new ResourceNotFoundException(
                            "Không tìm thấy chính sách giảm giá cho hạng khách hàng: "
                                    + dto.getCustomerLoyaltyLevel()));
