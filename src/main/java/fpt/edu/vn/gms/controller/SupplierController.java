...
public class SupplierController {
    ...
    @ApiResponses(value = {
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "200", description = "Lấy danh sách nhà cung cấp thành công",
    ...
    @ApiResponses(value = {
        @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "200", description = "Lấy thông tin nhà cung cấp thành công",
            content = @Content(mediaType = "application/json", schema = @Schema(implementation = SupplierResponseDto.class))),
    ...
    @ApiResponses(value = {
        @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "200", description = "Tạo nhà cung cấp thành công",
            content = @Content(mediaType = "application/json", schema = @Schema(implementation = SupplierResponseDto.class))),
    ...
    public ResponseEntity<SupplierResponseDto> createSupplier(
            @io.swagger.v3.oas.annotations.parameters.RequestBody(description = "Thông tin nhà cung cấp", required = true, content = @Content(schema = @Schema(implementation = SupplierRequestDto.class)))
            @Valid @org.springframework.web.bind.annotation.RequestBody SupplierRequestDto supplierRequestDto) {
    ...
    public ResponseEntity<SupplierResponseDto> updateSupplier(
            ...
            @io.swagger.v3.oas.annotations.parameters.RequestBody(description = "Thông tin nhà cung cấp cập nhật", required = true, content = @Content(schema = @Schema(implementation = SupplierRequestDto.class)))
            @Valid @org.springframework.web.bind.annotation.RequestBody SupplierRequestDto supplierRequestDto) {
        return ResponseEntity.ok(supplierService.updateSupplier(id, supplierRequestDto));
    }

    @DeleteMapping("/{id}")
    @Operation(summary = "Xóa mềm nhà cung cấp", description = "Xóa mềm một nhà cung cấp dựa trên ID (chỉ cập nhật trường isActive).")
    @ApiResponses(value = {
        @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "204", description = "Xóa nhà cung cấp thành công"),
        @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "404", description = "Không tìm thấy nhà cung cấp", content = @Content(schema = @Schema(hidden = true))),
        @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "500", description = "Lỗi máy chủ nội bộ", content = @Content(schema = @Schema(hidden = true)))
    })
