...
class SupplierServiceImplTest {
    ...
    @Test
    void softDeleteSupplier_ShouldSetInactive_WhenFound() {
        Supplier supplier = Supplier.builder()
                .id(1L)
                .name("ABC")
                .isActive(true)
    ...
    @Test
    void softDeleteSupplier_ShouldThrow_WhenNotFound() {
        when(supplierRepository.findById(1L)).thenReturn(Optional.empty());

        assertThrows(ResourceNotFoundException.class, () -> service.softDeleteSupplier(1L));
    }
}
