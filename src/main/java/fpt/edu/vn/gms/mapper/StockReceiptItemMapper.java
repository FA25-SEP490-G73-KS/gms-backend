...
public interface StockReceiptItemMapper {
    ...
    @Mapping(target = "sku", source = "purchaseRequestItem.part.sku")
    @Mapping(target = "supplierId", source = "purchaseRequestItem.part.supplier.id")
    @Mapping(target = "supplierName", source = "purchaseRequestItem.part.supplier.name")
