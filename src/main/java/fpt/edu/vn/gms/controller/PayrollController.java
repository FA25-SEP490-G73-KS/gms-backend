...
public class PayrollController {
    ...
    @Operation(
            summary = "Xem bảng lương tạm tính",
            description = """
    ...
    public ResponseEntity<ApiResponse<PayrollMonthlySummaryDto>> getPreview(
            @Parameter(description = "Tháng cần xem lương", example = "1")
            @RequestParam Integer month,

            @Parameter(description = "Năm cần xem lương", example = "2025")
    ...
    public ResponseEntity<ApiResponse<Void>> submitPayroll(
            @Parameter(description = "Tháng muốn nộp", example = "1")
            @RequestParam Integer month,

            @Parameter(description = "Năm muốn nộp", example = "2025")
            @RequestParam Integer year,

            @Parameter(description = "ID kế toán nộp bảng lương", example = "10")
    ...
    @Operation(
            summary = "Quản lý duyệt bảng lương",
            description = """
    ...
    public ResponseEntity<ApiResponse<Void>> approve(
            @Parameter(description = "ID payroll cần duyệt", example = "123")
            @PathVariable Long id,

            @Parameter(description = "ID quản lý duyệt", example = "5")
    ...
    @Operation(
            summary = "Chi lương cho nhân viên",
            description = """
    ...
    public ResponseEntity<ApiResponse<Void>> pay(
            @Parameter(description = "ID payroll cần chi lương", example = "123")
            @PathVariable Long id,

            @Parameter(description = "ID kế toán thực hiện chi lương", example = "10")
            @CurrentUser Employee accountant) {
    ...
    @Operation(
            summary = "Xem chi tiết lương nhân viên",
            description = """
