...
public final class AppRoutes {
  ...
  public static final String PURCHASE_ORDERS_PREFIX = API_PREFIX + "/purchase-orders";
  public static final String PURCHASE_REQUESTS_PREFIX = API_PREFIX + "/purchase-requests";
